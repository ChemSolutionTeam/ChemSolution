...
class Element extends Model {
  ...
  int energyLevels;
  dynamic meltingTemperature;
  dynamic boilingTemperature;
  bool isLocked;
  String info;
  String imgSymbol;
  String imgAtom;
 ...
 List<Map<String, dynamic>> elementMaterialsMaps = [];
  ...
  static Element fromObject(dynamic o) {
    ...
    e.atomicRadius = o['atomicRadius'] ?? 'Не відомо';
    e.electronegativity = o['electronegativity'] ?? 'Не відомо';
    e.category = Category.fromObject(o['category']);
    e.categoryId = o['categoryId'];
    e.energyLevels = o['energyLevels'];
    e.meltingTemperature = o['meltingTemperature'] ?? 'Не відомо';
    e.boilingTemperature = o['boilingTemperature'] ?? 'Не відомо';
